...
The [self-growing pipeline](../scripts/mine-gaps.mjs) measured **10** real-world requests against the **515** skills in the catalog. It found **4** genuinely uncovered and **6** already served.
